<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VeCuaToi.aspx.cs" Inherits="v2.VeCuaToi" %>
...
<body>
    ...
    <!-- content -->
    <div class="content">
        <div class="vctKhung" id="vctKhung" runat="server">
        
        </div>

        <div class="TongTien" runat="server" id="TongTien">
