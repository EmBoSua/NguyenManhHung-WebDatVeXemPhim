<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChonNgay.aspx.cs" Inherits="v2.ChonNgay" %>
...
<head runat="server">
    ...
    <link href="css/chonTP.css" rel="stylesheet" />
</head>
<body>
    ...
    <div class="content">
        <div class="divKhungCTP">
            <div class="divAnhPhim" runat="server" id="divAnhPhim">
                
            </div>
            <div class="chonThanhPho">
                <h2>Chọn Lịch Chiếu</h2>
                <hr class="dongKe1">
                <div class="allBTN" id="allBTN" runat="server">
